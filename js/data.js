...
const ARTWORKS = {
  'Seni Tradisional': [
    {
      id: 0,
      title: 'Potret Diri 1',
      desc: 'Sketsa pensil pada medium kertas coklat.Sketsa dari wajah lelah diri sendiri.',
      pid: 'Tradi1-Self1_yi5jne',
    },
    {
      id: 1,
      title: 'Potret Diri 2',
      desc: 'Sketsa pensil pada medium kertas putih ukuran B5. Sketsa wajah sendiri dengan modifikasi di bagian jenggot. Eksplorasi penambahan elemen pada objek.',
      pid: 'Tradi2-Self2_cqtfij',
    },
    {
      id: 2,
      title: 'Potret Diri 3',
      desc: 'Sketsa pensil pada medium kertas putih ukuran A5. Sketsa wajah dan profil sendiri dengan penyesuaian pakaian dari beberapa referensi',
      pid: 'Tradi3-Self3_cuochx',
    },
    {
      id: 3,
      title: 'Potret Diri 4',
      desc: 'Sketsa pensil pada medium kertas putih ukuran A5. Sketsa diri menjadi karakter musisi bermain gitar.',
  ...
  'Fotografi': [
    ...
    },
    {
      id: 10,
      title:'Mengaum',
      desc: 'Salah satu beruang di dalam kebun binatang Ragunan, dari dalam kandangnya. Memberikan kesan iba kepada sang binatang buas yang seharusnya bebas hidup di alam liar dan bukan terkungkung di balik jeruji dan dinding tebal.',
  ...
  'Arsitektur': [
    {
      id: 0,
      title: 'Spazio Tower',
      desc: 'Mixed Use di Surabaya.',
      pid: 'spazio_pzv406',
    },
    {
      id: 1,
      title: 'Setiabudi Mixed Use',
      desc: 'Mixed Use di Semarang.',
    ...
    },
    {
      ...
      desc: 'Galeri seni di Batu, Malang.',
      pid: 'art-gallery-1_rpsjj6',
    },
    {
      id: 4,
      title: 'Patra Residence',
      desc: 'Apartemen di Patra Kuningan, Jakarta.',
      pid: 'ptr-4_hv7e8u',
    },
    {
      id: 5,
      title: 'Siloam Hospital Manado',
      desc: 'Rumah sakit di Manado.',
      pid: 'shm-0_pvg2xb',
    },
    {
      id: 6,
      title: 'Kramat Jati Indah Refurbishment',
      desc: 'Pusat perbelanjaan di Kramat Jati, Jakarta.',
      pid: 'kji-1_kcoydw',
    },
    {
      id: 7,
      title: 'Signage',
      desc: 'Signage di Kuta, Bali.',
      pid: 'signage-0_slzrto',
    },
    {
      id: 8,
      title: 'Rumah Bandung',
      desc: 'Rumah pribadi di Bandung.',
      pid: 'ph-1_sd5l8b',
    },
  ],
};
